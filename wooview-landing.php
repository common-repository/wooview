    ...
    <div class="grid grid-pad block">
      <div class="col-1-1">
         <div class="content">
            ...
            <?php if( version_compare($GLOBALS['wooview_min_wp_version'], $GLOBALS['wooview_wp_version'], '>') ): $has_errors = true; ?>
            ...
            <?php else: ?>
              <?php if( version_compare($GLOBALS['wooview_min_wc_version'], $GLOBALS['wooview_wc_version'], '>') ): $has_errors = true; ?>
      ...
      <div class="col-1-3">
         <div class="content">
             <h3><?php echo (version_compare($GLOBALS['wooview_min_wp_version'], $GLOBALS['wooview_wp_version'], '<')) ? '<div class="dashicons dashicons-yes"></div>' : '<div class="dashicons dashicons-no-alt"></div>'; ?>Wordpress</h3>
      ...
      <div class="col-1-3">
         <div class="content">
             <h3><?php echo (version_compare($GLOBALS['wooview_min_wc_version'], $GLOBALS['wooview_wc_version'], '<')) ? '<div class="dashicons dashicons-yes"></div>' : '<div class="dashicons dashicons-no-alt"></div>'; ?>Woocommerce</h3>
